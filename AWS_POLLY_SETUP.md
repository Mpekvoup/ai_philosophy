...
✅ **Качество** - Профессиональные голоса высочайшего качества
...
**Free Tier включает:**
- 5 миллионов символов в месяц (Standard TTS)
...
**Причина:** Регион не поддерживает русские голоса

**Решение:**
1. Измените `AWS_POLLY_REGION=us-east-1` в .env
2. Перезапустите сервер
3. us-east-1 гарантированно поддерживает русские голоса
...
### После Free Tier
- **$4.00 за 1 миллион символов** (Standard TTS)
